...
contract BookkeeperRegistry is Governable {
    ...
    function getVaultInfoMultipleStrategies(address _vault)
        internal
        view
        validVault(_vault)
        multipleStrategies(_vault)
        returns (
            uint256,
            address[] memory,
            uint256[] memory,
    ...
    function getRewardPoolInfoSingleStrategy(address _vault)
        internal
        view
        validVault(_vault)
        singleStrategy(_vault)
    ...
    function getRewardPoolInfoMultipleStrategies(address _vault)
        internal
        view
        validVault(_vault)
        multipleStrategies(_vault)
    ...
    function getRewardPoolInfo(address _rewardPool)
        external
        view
    ...
    function getUnderlyingInfo(address _underlying)
        external
        view
        validUnderlying(_underlying)
        returns (
            address[] memory,
            uint256[] memory,
            address[] memory,
